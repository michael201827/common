...
public class MonthMarker {
    ...
    public static void parse(String text, StringBuilder out, Map<Object, Object> context, String monthVariable) {
        int currentIndex = 0;
        while (currentIndex < text.length()) {
            if (text.charAt(currentIndex) != '$') {
                ...
                currentIndex++;
                ImmutablePair<Match, Integer> result = readDateVariable(text, currentIndex, monthVariable);
                if (result.left == null) {
                    out.append(dollar);
                    continue;
                } else {
                    String str = result.left.generateString(context, monthVariable);
                    out.append(str);
    ...
    private static class Match {
        ...
        public String generateString(Map<Object, Object> context, String key) {
            ...
            if (value == null) {
                ...
                str = DateUtil.format(cal.getTimeInMillis(), "yyyyMM");
                return str;
            }
        }
    }
