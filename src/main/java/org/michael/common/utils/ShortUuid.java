...
public final class ShortUuid {
    ...
    public static String newShortUuid() {
        ...
        ShortUuid tmp = builder.build();
        String strUuid = tmp.toString();
        char c = strUuid.charAt(0);
    ...
    private static boolean isAlphabetLetter(char c) {
        boolean f = (c >= 'a' && c <= 'a') || (c >= 'A' && c <= 'Z');
        return f;
    }
    ...
    public static class Builder {
        ...
        private String decode(final char[] encoded, final char[] alphabet) {
            ...
            StringBuilder sb = new StringBuilder().append(str.substring(0, 8)).append("-").append(str.substring(8, 12)).append("-")
                    .append(str.substring(12, 16)).append("-").append(str.substring(16, 20)).append("-").append(str.substring(20, 32));
